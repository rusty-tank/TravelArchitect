...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, OnClickListener {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(LoginActivity.this, "Welcome to TravelArchitect!", Toast.LENGTH_SHORT).show();
    ...
    public void switchOption() {
        String option =  mLoginButton.getText().toString();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Log.i("Failed to sign up", task.getException().getLocalizedMessage());
                        }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivity.this, "Failed to login.",
                                    Toast.LENGTH_SHORT).show();
                            Log.i("Failed to login", task.getException().getLocalizedMessage());
                        }
